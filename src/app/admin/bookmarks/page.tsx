...
import { BookmarksList } from "~/app/_components/admin/bookmarks-list";
				...
				<main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
					...
					<div className="mb-8">
						<div className="flex items-center justify-between">
							<div>
								<h1 className="text-2xl font-bold text-gray-900">ブックマーク一覧</h1>
								<p className="text-gray-600 mt-1">あなたがブックマークした記事の一覧です</p>
							</div>
