	...
	return (
		<div className="mt-6 bg-white rounded-lg shadow p-6">
			...
			{isLoading ? (
				...
				<div className="rounded-lg hover:bg-gray-50 transition-colors p-3 -m-3">
					<div className="flex items-start space-x-3">
						...
						<div className="flex-1 min-w-0">
							<p className="text-sm font-medium text-gray-900 hover:text-blue-600 transition-colors truncate">
							...
							<Link 
								href="/profile"
								className="inline-block text-xs text-blue-600 mt-2 hover:text-blue-800 transition-colors"
							>
								プロフィール設定 →
							</Link>
						</div>
